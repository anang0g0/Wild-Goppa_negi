                ...
                while (i < F)
                {
                    ...
                    {   
                        ...
                        if (buf > 0)
                        {
                            for (int j = 0; j < F; j++)
                            {
                                a.x[i][j] = (a.x[i][j] + a.x[s][j]) % Pr;
                                inv_a.x[i][j] = (inv_a.x[i][j] + inv_a.x[s][j]) % Pr;
                            }
                        }
                        printf("s=%d\n", s);
                        if (s == F)
                    ...
                    for (int k = 0; k < F; k++)
                    {
                        a.x[i][k] = (a.x[i][k] * buf) % Pr;
                        inv_a.x[i][k] = (inv_a.x[i][k] * buf) % Pr;
                        printf("!%d ", a.x[i][k]);
                    }
                    printf("\n");
                    // exit(1);
                    ...
                    for (int k = 0; k < F; k++)
                    {
                        ...
                        for (int j = 0; j < F; j++)
                        {
                            if (j != k)
                            {
                                a.x[k][j] = (Pr + a.x[k][j] - (a.x[i][j] * buf) % Pr) % Pr;
                                inv_a.x[k][j] = (Pr + inv_a.x[k][j] - (inv_a.x[i][j] * buf) % Pr) % Pr;
                            }
                            // printf("!%d,", a.x[k][j]);
                        }
                        printf("\n");
